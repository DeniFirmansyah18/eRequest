...
<?php $component->withAttributes([]); ?>
    <h1 class="text-3xl text-gray-800 dark:text-gray-100 font-bold mb-6 text-center"><?php echo e(__('eRequest')); ?></h1>
...
<?php endif; ?>
    ...
    <!--<div class="pt-5 mt-6 border-t border-gray-100 dark:border-gray-700/60">
        <div class="text-sm">
            <?php echo e(_('Belum memiliki akun?')); ?> <a class="font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="<?php echo e(route('register')); ?>"><?php echo e(_('Daftar')); ?></a>
        </div>
        <div class="text-sm">
            <?php echo e(_('Lupa Kata Sandi?')); ?> <a class="font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="<?php echo e(route('password.request')); ?>"><?php echo e(_('Ubah')); ?></a>
        </div>
    </div>-->
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\eRequest\resources\views/auth/login.blade.php ENDPATH**/ ?>